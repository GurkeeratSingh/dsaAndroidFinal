...
public class Main3Activity extends AppCompatActivity {//seguidoesss
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            String user = intent2.getStringExtra("usuario");
            TextView buscado = (TextView) findViewById(R.id.titulo);
            ...
            Call<List<Seguidor>> call = interfazAPI.seguidos(user);
            ...
            call.enqueue(new Callback<List<Seguidor>>() {
                ...
                public void onResponse(Call<List<Seguidor>> call, Response<List<Seguidor>> response) {
                    ...
                    if(response.code()==200){
                        ...
                        miAdapter adapter=new miAdapter(Main3Activity.this, nombres, list_URLs,list_type);
                        ...
                        Toast.makeText(Main3Activity.this, "Error del server: "+response.code(), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Main3Activity.this, "Error de conexió, probable mala url", Toast.LENGTH_SHORT).show();
        }
    }
}
